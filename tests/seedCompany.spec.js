...
describe('SeedCompany.seedCompany()', () => {
  ...
  it('returns error message', () =>
    SeedCompany.seedCompany('VUJCJ4TYMG00000000000000')
    .catch((err) => expect(err).to.be.an('error'))
  );
  it('returns error message', () =>
    SeedCompany.seedCompany('VUJCJ4TYMG00&000000000000')
    .catch((err) => expect(err).to.be.an('error'))
  );
  it('returns error message', () =>
    SeedCompany.seedCompany('VUJCJ4TYMG00 000000000000')
  ...
  it('returns error message', () =>
    SeedCompany.seedCompany('VUJCJ4TYMG00_000000&00000')
    .catch((err) => expect(err).to.be.an('error'))
  );
  it('returns error message', () =>
...
describe('SeedCompany.strains()', () => {
  ...
  it('returns error message', () =>
    SeedCompany.strains('VUJCJ4TYMG00000000000000').catch((err) => expect(err).to.be.an('error'))
  );
  it('returns error message', () =>
    SeedCompany.strains('VUJCJ4TYMG00&000000000000').catch((err) => expect(err).to.be.an('error'))
  );
  it('returns error message', () =>
    SeedCompany.strains('VUJCJ4TYMG00 000000000000').catch((err) => expect(err).to.be.an('error'))
  );
  it('returns error message', () =>
    SeedCompany.strains('VUJCJ4TYMG00_000000&00000').catch((err) => expect(err).to.be.an('error'))
  );
  it('returns error message', () =>
...
describe('SeedCompany.reviews()', () => {
  ...
  it('returns error message', () =>
    SeedCompany.reviews('VUJCJ4TYMG00000000000000').catch((err) => expect(err).to.be.an('error'))
  );
  it('returns error message', () =>
    SeedCompany.reviews('VUJCJ4TYMG00&000000000000').catch((err) => expect(err).to.be.an('error'))
  );
  it('returns error message', () =>
    SeedCompany.reviews('VUJCJ4TYMG00 000000000000').catch((err) => expect(err).to.be.an('error'))
  );
  it('returns error message', () =>
    SeedCompany.reviews('VUJCJ4TYMG00_000000&00000').catch((err) => expect(err).to.be.an('error'))
  );
  it('returns error message', () =>
